...
{
    if(req.url === "/channel.html" || req.url === "/bootstrap.min.css" || req.url === "/bootstrap.min.js" || req.url === "/FBLogo.png" || req.url === "/loading.gif" || req.url === "/favicon.ico" || req.url === "/refriend64v2.png") {
